  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f1f10] via-[#1a2e1b] to-[#0d1a0e] flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-lg w-full">
        ...
        {/* Animated checkmark */}
        <div className="w-20 h-20 bg-[#b2d650]/15 border-2 border-[#b2d650]/40 rounded-full flex items-center justify-center mx-auto mb-6 animate-bounce-once">
        ...
        {waUrl ? (
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-5 mb-6">
            <p className="text-white/60 text-sm">Our team will contact you shortly on your registered number.</p>
          </div>
        )}
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .animate-bounce-once { animation: bounce-once 0.6s ease-out 0.2s both; }
      `}} />
    </div>
  );
}
...
export default function ThankYouPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-[#0f1f10] flex items-center justify-center">
        <div className="w-8 h-8 border-2 border-[#b2d650] border-t-transparent rounded-full animate-spin" />
      </div>
    }>
      <ThankYouContent />
    </Suspense>
